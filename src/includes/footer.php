            ...
            <div class="modal-body">
                <form method="post" id="frmPass">
                    <div class="form-group">
                        <label for="actual"><i class="fas fa-key"></i> Contrase&ntilde;a Actual</label>
                        <input id="actual" class="form-control" type="text" name="actual" placeholder="Contraseña actual" required>
                    </div>
                    <div class="form-group">
                        <label for="nueva"><i class="fas fa-key"></i> Contrase&ntilde;a Nueva</label>
                        <input id="nueva" class="form-control" type="text" name="nueva" placeholder="Contraseña nueva" required>
                    </div>
                    <button class="btn btn-primary" type="button" onclick="btnCambiar(event)">Cambiar Contraseña</button>
                </form>
            </div>
        </div>
    </div>
